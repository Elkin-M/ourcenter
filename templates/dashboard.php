        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function adjustForScreenSize() {
                if (window.innerWidth < 768) {
                    ...
                    body.classList.add('mobile-view', 'sidebar-hidden');
                    body.classList.remove('sidebar-hidden-by-user');
                    
                    // Elimina el estilo en línea y usa clases CSS
                    mainContent.style.marginLeft = ''; // Elimina el estilo en línea
                    mainContent.classList.add('mobile-layout');
                } else {
                    // Modo desktop
                    body.classList.remove('mobile-view', 'sidebar-hidden');
                    mainContent.classList.remove('mobile-layout');
                    
                    if (!body.classList.contains('sidebar-hidden-by-user')) {
                        sidebar.classList.add('show');
                        // Asegúrate de eliminar cualquier estilo en línea residual
