   ...
   <style>
    ...
    margin-left: 10px;">OUR CENTER</div>
        ...
        <ul class="nav flex-column mt-3">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'mis-cursos.php') ? 'active' : ''; ?>" href="../estudiante/mis-cursos.php">
                    <i class="fas fa-book me-2"></i>
                    Mis Cursos
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'inscripciones.php') ? 'active' : ''; ?>" href="inscripciones.php">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'calendario.php') ? 'active' : ''; ?>" href="calendario.php">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo ($current_page == 'soporte.php') ? 'active' : ''; ?>" href="soporte.php">
                    <i class="fas fa-headset me-2"></i>
                    Soporte
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="inscripciones.php?action=nueva">
                    <i class="fas fa-plus-circle me-2"></i>
                    Nueva Inscripción
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="pagos.php?action=pendientes">
